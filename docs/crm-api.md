...
app_price_list(): Rewards. rows: id, name, price, points, section (colour, hair, davines, other), family (all, micro, tapes, wefts, topper or clip_in). Opens on Hair (hair and other), then Colour, Davines, All; only rows her balance covers and her family's rows plus the rows for all. Every name shows with a capital on every word. Maintenance and re-do services (care, re-do, refit) are never shown as rewards.
...
Tier states in the app (25 September): next_tier set is a climb towards it. keep_year_next and keep_points set is her stay year, and her tier_points count towards keeping the tier. next_tier null with keep_year_next null is Gold or Black before the stay year: Home shows the tier and "until tier_until", Card and How Tiers Work show 0 against gold_keep or black_keep with "Counted during [year of tier_until]. Reviewed on 1 January", and the card reads "[Tier] for [year of tier_until plus 1]".
First tier year (Shawn, 22 September): launch to 31 December 2027 is one tier year, and a tier reached in it lasts until 31 December 2028; tier_until carries that date. From 2028 a tier year runs 1 January to 31 December.
