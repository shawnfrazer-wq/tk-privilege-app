...
- app_settings, pound companions for the fixed copy, 25 September: the app now reads the scheme figures in its fixed text from app_settings and app_tier_rules (booking bonus, £200 and the 5 and 7 weeks, the redeem rate, referral and review points, first colour discount, Care Card boxes and points, expiry months, Gold and Black targets). Four figures have no CRM value and stay as the wireframe's words until one is sent: the pound values beside the referral points ("500 points, £50" and "1,000 points, £100"), so bonus_referral_referrer_pounds and bonus_referral_referred_pounds; "500 for both" on Review, so bonus_review_share_both; and the "3 months before" notice on expiry, so points_expiry_notice_months. The worked example on How Points Work and the FAQ (a £400 maintenance: 400, 300 and 200 TK Points, £40, £30 and £20) is fixed text too, because the band shares are not sent; an example block on app_tier_rules (spend_pounds, full_points, three_quarter_points, half_points and their pounds) would let the app read it.
